{% extends "index.html" %} {% block content %} {% for x in alldolls %}
<div class="row">
    <div class="col-md-2">
        <div class="grid">
    ...
    <center>
        <div class='panel-footer'>
            ...
            <ul class='pagination pagination-sm' id="pagination">
                ...
                {% else %}
                <li class="prev">
                    <a href='displaydoll.php?page={{ 1 }}'>
                        <i class="fa fa-angle-double-left">First</i>
                    </a>
                </li>
                <li class="prev">
                    <a href='displaydoll.php?page={{ page - 1 }}'>
                        <i class="fa fa-angle-left">Prev</i>
                    </a>
                </li>
                ...
                <li class="next">
                    <a href='displaydoll.php?page={{ total_pages }}'>
                        <i class="fa fa-angle-double-right">Last</i>
                    </a>
                </li>
                {% endif %} {% endif %} {% endfor %}
